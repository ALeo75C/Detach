...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { brand_id: @follow.brand_id, profile_id: @follow.profile_id } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { brand_id: @follow.brand_id, profile_id: @follow.profile_id } }
